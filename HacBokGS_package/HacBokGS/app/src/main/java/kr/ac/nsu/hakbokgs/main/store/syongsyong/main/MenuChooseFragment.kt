...
class MenuChooseFragment : DialogFragment() {
    private val tag = "SsyongMenuChoose"
    private var _binding: FragmentMenuChooseNoOptionBinding? = null
    private val binding get() = _binding!!

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val dialog = super.onCreateDialog(savedInstanceState)
        _binding = FragmentMenuChooseNoOptionBinding.inflate(layoutInflater)
        ...
        binding.btnAddCart.setOnClickListener {
            ...
            FirebaseFirestore.getInstance()
                ...
                .addOnSuccessListener {
                    ...
                    val intent = Intent(requireContext(), SsyongListActivity::class.java)
