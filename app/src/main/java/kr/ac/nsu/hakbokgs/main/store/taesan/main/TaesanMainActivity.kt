...
import kr.ac.nsu.hakbokgs.databinding.ActivityTaesanMainBinding
...
class TaesanMainActivity : AppCompatActivity() {

    private lateinit var binding: ActivityTaesanMainBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTaesanMainBinding.inflate(layoutInflater)
        setContentView(binding.root)

        // 👇 메인 버튼 클릭 시 메뉴 리스트 화면으로 이동
        binding.taesanMain.setOnClickListener {
            val intent = Intent(this, TaesanListActivity::class.java)
