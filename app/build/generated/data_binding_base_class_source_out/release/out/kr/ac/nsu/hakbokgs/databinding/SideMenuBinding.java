...
public final class SideMenuBinding implements ViewBinding {
  ...
  private SideMenuBinding(@NonNull FrameLayout rootView, @NonNull ImageView menuImage,
  ...
  @NonNull
  public static SideMenuBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SideMenuBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.side_menu, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SideMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SideMenuBinding((FrameLayout) rootView, menuImage, menuName);
    }
